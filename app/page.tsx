...
export default function HomePage() {
  ...
  const handleRefresh = async () => {
    ...
    setStats({
      conditions: 150 + Math.floor(Math.random() * 10),
      articles: 500 + Math.floor(Math.random() * 50),
      availability: "24/7",
    })
    setIsLoading(false)
  }
  ...
  return (
    <PullToRefresh onRefresh={handleRefresh}>
      <div className="min-h-screen bg-background pb-20">
        ...
        <section className="px-4 mb-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              <InteractiveCard className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200" glowEffect>
                <CardContent className="p-4">
                  <Link href="/symptom-checker" className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
              ...
              <InteractiveCard className="bg-gradient-to-br from-green-50 to-green-100 border-green-200" glowEffect>
                <CardContent className="p-4">
                  <Link href="/diet" className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-3 gap-3">
                <InteractiveCard className="text-center" pressEffect>
                  <CardContent className="p-4">
                    <Activity className="h-6 w-6 text-primary mx-auto mb-2 transition-transform duration-200 hover:scale-110" />
                ...
                <InteractiveCard className="text-center" pressEffect>
                  <CardContent className="p-4">
                    <BookOpen className="h-6 w-6 text-primary mx-auto mb-2 transition-transform duration-200 hover:scale-110" />
                    <p className="text-2xl font-bold text-foreground transition-all duration-300">{stats.articles}+</p>
                ...
                <InteractiveCard className="text-center" pressEffect>
                  <CardContent className="p-4">
                    <TrendingUp className="h-6 w-6 text-primary mx-auto mb-2 transition-transform duration-200 hover:scale-110" />
                    <p className="text-2xl font-bold text-foreground">{stats.availability}</p>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              <InteractiveCard pressEffect>
                <Button variant="outline" className="h-16 justify-start gap-3 bg-background w-full" asChild>
                  <Link href="/diseases?category=infectious">
                    <div className="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
              ...
              <InteractiveCard pressEffect>
                <Button variant="outline" className="h-16 justify-start gap-3 bg-background w-full" asChild>
                  <Link href="/diseases?category=chronic">
                    <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
              ...
              <InteractiveCard pressEffect>
                <Button variant="outline" className="h-16 justify-start gap-3 bg-background w-full" asChild>
                  <Link href="/diseases?category=injuries">
                    <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
              ...
              <InteractiveCard pressEffect>
                <Button variant="outline" className="h-16 justify-start gap-3 bg-background w-full" asChild>
                  <Link href="/diseases?category=mental">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
            ...
            <InteractiveCard pressEffect>
              <CardContent className="p-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 transition-all duration-200 hover:translate-x-1">
        ...
        <section className="px-4 mb-6">
          <div className="container mx-auto max-w-4xl">
            <InteractiveCard className="bg-red-50 border-red-200" pressEffect>
              <CardContent className="p-4">
